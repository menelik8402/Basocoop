    ...
    <div class="row">
        <div class="col-sm-8 hidden-xs" style="padding-left: 15px; padding-right: 15px; background-color: #fff">
            ...
            <small style="text-align: justify">
                <p>El Plan de Gestión Social - Balance Social constituye un instrumento de gestión
                    que utilizan cooperativas de la Federación de Cooperativas de Ahorro y Crédito
                    de El Salvador (FEDECACES), para planificar, organizar, medir y evaluar el
                    cumplimiento de su Responsabilidad Social en correspondencia con su naturaleza
                    y esencia, así como para conocer el impacto que su desempeño social genera en
                    sus asociados, directivos, empleados, sus familias y los miembros de la comunidad
                    donde estas empresas se encuentran insertadas.</p>
                <p></p>
        ...
        <div class="col-sm-4 hidden-print" style="background-color: #fff">
            <div class="panel-login">
                ...
                <div class="panel-login">
                    ...
                    <div  align="center">
                        <a href="/registerinv"  ><h5><strong>Usuario Invitado</strong></h5></a>
                    </div>
                        </section>
                </div>
               {{-- <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
