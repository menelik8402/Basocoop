        ...
        <section class="tabla">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h1 class="panel-title">Reporte de actividades por Cooperativa</h1>
                </div>
                <div class="panel-body">
                    <form action="/proyectos/rep/fecha/coop" method="get">

                        <div class="form-inline justify-content-center" >
                            <label  class=" pull-left">Cooperativa :</label>
                            <div CLASS=" @if($errors->has('coop')) border-danger @endif">
                                <select id="coop" name="coop" disabled class="form-control justify-content-center">
