                                    ...
                                    <div>
                                        ...
                                        <table border="2" class="table  table-bordered table-sm table-hover tabla">
                                            ...
                                            <tr >
                                                ...
                                                <td>{{ $compAsam_ant!=null ? round(($compAsam_ant->convocadas * 100 /$totalcdcd) + ($compAsam_ant->efectuadas * 100 /$totalcd) + ($compAsam_ant->delegados * 100 /$totalcd),2) : 0}}</td>
                            ...
                            <section class="Tabla">
                                <div>
                                    ...
                                    <table border="2" class="table  table-bordered table-sm table-hover tabla">
                                        ...
                                        <tr >
                                            <td><h6>Inversión realizada en el proceso de formación y capacitación</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Inversión en educación, formación e información para jóvenes</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Inversión en educación, formación e información para mujeres</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Inversión en educación, formación e información para empleados</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Inversión en educación, formación e información para directivos</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Inversión en educación, formación e información para niños</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Inversión en educación, formación e información para miembros de la comunidad</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Número de actividades en educación, formación e información</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Número de actividades en educación, formación e información para jóvenes</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Número de actividades en educación, formación e información para mujeres</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Número de actividades en educación, formación e información para asociados</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Número de actividades en educación, formación e información para empleados</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Número de actividades en educación, formación e información para directivos</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Número de actividades en educación, formación e información para niños</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Número de actividades en educación, formación e información para miembros de la comunidad</h6> </td>
                                        ...
                                        <tr >
                                            <td><h6>Cantidad de participantes en actividades de educación, formación e información</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Cantidad de participantes en actividades de educación, formación e información para jóvenes</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Cantidad de participantes en actividades de educación, formación e información para mujeres</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Cantidad de participantes en actividades de educación, formación e información para asociados</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Cantidad de participantes en actividades de educación, formación e información para empleados</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Cantidad de participantes en actividades de educación, formación e información para directivos</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Cantidad de participantes en actividades de educación, formación e información para niños</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Cantidad de participantes en actividades de educación, formación e información para miembros de la comunidad</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Cantidad de participantes en actividades de educación, formación e información sobre la filosofía cooperativa</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Cantidad de actividades para la formación de habilidades</h6></td>
                                        ...
                                        <tr >
                                            <td><h6>Cantidad de participantes en actividades para la formación de habilidades</h6></td>
                                ...
                                @foreach($progs as $key => $prog)
                                    <tr>
                                        ...
                                        @if(round($sum_num_ben_satif,2) > 100 )
                                            <td>{{round($pat_social,2)}} <small>ASA</small> </td>
                                            <td>0</td>
