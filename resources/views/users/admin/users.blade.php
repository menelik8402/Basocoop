                       ...
                       {{-- <th>Fecha de creado</th>--}}
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                @if($user->id_coop!=null)
                                    <td>{{$user->Cooperativa->nombre}}</td>
                                @else
                                    <td>FEDECACES</td>
                                @endif
                               ...
                               {{-- <td> <a href="#" onclick="editar({{$user->id}})"  id="edit"  class="boton btn pull-left"><i class="fa fa-edit"></i>+</a> |  <a href="#" onclick="eliminar({{$user->id}})"  id="elim"   class="boton btn pull-right"><i class="fa  fa-eraser"></i>-</a></td>--}}
                                <td><div class="dropdown show pull-right">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal form" id="formuser">
                        ...
                        <div class="form-group row ">
                            <label for="nom" class="col-sm-4 col-form-label">Contaseña</label>
                            <div class="col-sm-5 ">
                        ...
                        <div class="form-group row ">
                            <label for="nom" class="col-sm-4 col-form-label"> Confirmar Contaseña</label>
                            <div class="col-sm-5">
                            ...
                            <div class="col-sm-5">
                               <select id="id_rol" name="id_rol" class="form-control">
                                   ...
                                   @foreach($roles as $rol)
                                       @if($rol->nomb_rol!='Gestor Social' && $rol->nomb_rol!='Usuario' )
                        ...
                        <div class="form-group row ">
                            <label for="nom" class="col-sm-4 col-form-label">Seleccione la Institución</label>
                            <div class="col-sm-5">
                                <select id="id_coop" name="id_coop" disabled="disabled" class="form-control">
                                    <option value="0" selected="selected">----------SELECCIONE----------</option>
                                    @foreach($coops as $coop)
                                        <option value="{{$coop->id}}">{{$coop->nombre}}</option>
                                    @endforeach
                                    <div class="form-control-feedback text-danger" id="id_coopt"></div>
                                </select>
               ...
               <div class="modal-content">
                   ...
                   <div class="modal-body">
                      ...
                      {{-- @if(count($errors)>0)
                       ...
                       @endif--}}
                       <form class="form-horizontal form" id="idform">
                           ...
                           <div class="form-group row ">
                               ...
                               <div class="col-sm-5 ">
                                   ...
                                   <div class="form-control-feedback text-danger " id="citt"></div>
                               </div>
                           </div>
                           <div class="form-group row ">
                               <label for="nom" class="col-sm-4 col-form-label">Email</label>
                           ...
                           <div class="form-group row ">
                               ...
                               <div class="col-sm-5">
                                   ...
                                   <div class="form-control-feedback text-danger " id="logintt"></div>
                           ...
                           <div class="form-group row ">
                               ...
                               <div class="col-sm-5">
                                   <select id="id_coop1" name="id_coop1" disabled="disabled" class="form-control">
                                       <option value="0" selected="selected">----------SELECCIONE----------</option>
                                       @foreach($coops as $coop)
                        ...
                        if(arr['errors']!=null) {
                            ...
                            for(var miclave=0; miclave< claves.length;miclave++)
                            {
                                for(var i=0;i<  arr['errors'][claves[miclave]].length;i++  )
                                {
                                    ...
                                    $('#'+claves[miclave]+'tt').text(arr['errors'][claves[miclave]][i]);
                                }
