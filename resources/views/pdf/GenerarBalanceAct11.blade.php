                            ...
                            <div class="row justify-content-center">
                                ...
                                @foreach($progs as $key => $prog)
                                    ...
                                    <table class="table  table-bordered table-sm  table-hover tabla" border="2">
                                        ...
                                        <th class="col-sm-2"><h6>Actividad</h6></th>
                                        <th class="col-sm-2"><h6>Presupuest</h6>o</th>

                                       {{-- <th class="col-sm-2"><h6>Manifestación Numérica</h6></th>--}}
                                        ...
                                        <th class="col-sm-2"><h6>Unidades Fisicas Satif</h6></th>
                                        <th class="col-sm-2"><h6>Número de Beneficiarios Satif</h6></th>
